 ...
 * Original model: [Qwen3-0.6B](https://huggingface.co/Qwen/Qwen3-0.6B)

## Description
This is [Qwen3-0.6B](https://huggingface.co/Qwen/Qwen3-0.6B) model converted to the [OpenVINO™ IR](https://docs.openvino.ai/2025/documentation/openvino-ir-format.html) (Intermediate Representation) format with weights compressed to INT4 by [NNCF](https://github.com/openvinotoolkit/nncf).
...
Check the original [model card](https://huggingface.co/Qwen/Qwen3-0.6B) for limitations.
