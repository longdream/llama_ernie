 ...
 * Original model: [Qwen3-14B](https://huggingface.co/Qwen/Qwen3-14B)

## Description
This is [Qwen3-14B](https://huggingface.co/Qwen/Qwen3-14B) model converted to the [OpenVINO™ IR](https://docs.openvino.ai/2025/documentation/openvino-ir-format.html) (Intermediate Representation) format with weights compressed to INT4 by [NNCF](https://github.com/openvinotoolkit/nncf).
...
Check the original [model card](https://huggingface.co/Qwen/Qwen3-14B) for limitations.

## Legal information

The original model is distributed under [Apache License Version 2.0](https://huggingface.co/Qwen/Qwen3-14B/blob/main/LICENSE) license. More details can be found in [Qwen3-14B](https://huggingface.co/Qwen/Qwen3-14B).
